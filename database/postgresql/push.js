...
const createPushUser = (request, response) => {
    ...
    sql += " VALUES( 'PLISMPLUS', '" + sUser.userno + "', "
    ...
    sql +=" values('PLISMPLUS', '"+sUser.userno+"', '"+request.body.deviceId+"','NT', 'Y'),"
    sql +=" ('PLISMPLUS','"+sUser.userno+"', '"+request.body.deviceId+"','DD', 'Y'),"
    sql +=" ('PLISMPLUS','"+sUser.userno+"', '"+request.body.deviceId+"','TR', 'Y');"
